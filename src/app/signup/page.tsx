        ...
        <div className="glass-card p-6 sm:p-8 border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          {success && (
            <div className="bg-lime/10 border border-lime/20 rounded-xl p-3.5 mb-5 flex items-start gap-2.5">
              ...
              <p className="text-xs text-lime leading-normal">
                Pendaftaran berhasil! Silakan cek email Anda untuk verifikasi atau masuk menggunakan kredensial Anda. Mengalihkan...
              </p>
            </div>
          )}
